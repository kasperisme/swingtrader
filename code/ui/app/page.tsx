...
export default async function Home() {
  ...
  const heroHeadlineHighlight = cms?.heroHeadlineHighlight ?? "Read it before you trade.";
    ...
    <main className="min-h-screen bg-background text-foreground">
          ...
          <div className="grid items-center gap-x-12 gap-y-12 py-8 lg:grid-cols-12 lg:py-16">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="mt-5 max-w-md text-base leading-7 text-muted-foreground">
                See what a share price already pays for — and what it refuses to
                pay for — before you take the other side. Free, no account. Plus
                two tools that bring the signals to you.
              </p>
            ...
            <div className="lg:col-span-7">
              <div className="rounded-3xl border border-border bg-card/40 p-5 shadow-[0_24px_80px_-32px_rgba(0,0,0,0.6)] backdrop-blur-sm sm:p-6">
                <p className="px-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-muted-foreground">
                  ...
                  <span className="text-amber-500">pick one, or all three</span>
                </p>

                <div className="mt-4 grid gap-3">
                  {/* Path A — Narrative trading. First because it is the one
                      that needs no subscription at all: it is readable on the
                      next click, which makes it the cheapest yes on the page. */}
                  <div className="group relative rounded-2xl border border-amber-500/30 bg-amber-500/[0.04] p-5 transition duration-300 hover:-translate-y-0.5 hover:border-amber-400/60 hover:bg-amber-500/[0.09] hover:shadow-[0_16px_50px_-20px_rgba(245,158,11,0.35)]">
                    <div className="flex items-start gap-4">
                      <span className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-amber-400/40 bg-amber-500/10 transition-colors duration-300 group-hover:border-amber-400/60">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-1.5 text-sm leading-6 text-muted-foreground">
                          Open any ticker and read the story its price already
                          tells: what the market is paying for, what it declines
                          to pay for, and the one question that settles it.
                        </p>
                        <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2">
                          ...
                          >
                            Read a price narrative
                            <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
                          </Link>
                          {narrative.featured && (
                            <Link
                              href={`/quote/${narrative.featured.ticker}`}
                            ...
                            >
                              ...
                              Start with {narrative.featured.ticker}
                            </Link>
                          )}
                        </div>
                      </div>
      ...
      <section className="border-t border-border py-14 md:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Horizontally stacked document previews. Three-up once the narrative
              card has a reconstruction to show, two-up when it does not. */}
          <div
            className={`mt-10 grid gap-6 md:grid-cols-2 ${
              narrative.featured ? "lg:grid-cols-3" : ""
            }`}
          >
            ...
            {/* Narrative reconstruction — the shape only. What it SAYS is the
                worked example in the narrative-trading section below; putting
                the same prose in both would read as the page repeating itself. */}
            {narrative.featured && (
              <NarrativeTradingPreviewCard
                featured={narrative.featured}
                totalCovered={narrative.totalCovered}
              />
            )}
          </div>
        </div>
      ...
      {/* ── NARRATIVE TRADING ────────────────────────────────────── */}
      <NarrativeTradingSection showcase={narrative} />
