...
import { listRelationshipNetworkEdgesFromSearchParams } from "@/lib/api-v1/relationships-network-service";
import {
...
export async function GET(req: NextRequest) {
  ...
  const result = await listRelationshipNetworkEdgesFromSearchParams(req.nextUrl.searchParams);
