...
import { listNewsTrendsDimensionsFromSearchParams } from "@/lib/api-v1/news-trends-service";
import {
  NEWS_V1_CORS,
  newsV1JsonError,
...
export async function GET(req: NextRequest) {
  ...
  const result = await listNewsTrendsDimensionsFromSearchParams(req.nextUrl.searchParams);
