...
_DISPLAY_KEYS: dict[str, list[tuple[str, str]]] = {
    "MACRO_SENSITIVITY": [
        ("interest_rate_sensitivity_duration", "rate_dur"),
        ("interest_rate_sensitivity_debt",     "rate_debt"),
        ("dollar_sensitivity",                 "dollar"),
        ("inflation_sensitivity",              "inflation"),
        ("credit_spread_sensitivity",          "credit"),
        ("commodity_input_exposure",           "commodity"),
        ("energy_cost_intensity",              "energy"),
    ],
    "SECTOR_ROTATION": [
        ...
        ("sector_energy",       "enrg"),
        ("sector_realestate",   "re"),
        ("sector_consumer",     "cons"),
        ("sector_industrials",  "indus"),
        ("sector_utilities",    "util"),
    ],
    "BUSINESS_MODEL": [
        ("revenue_predictability",   "predictable"),
        ("revenue_cyclicality",      "cyclical"),
        ("pricing_power_structural", "pricing_s"),
        ("pricing_power_cyclical",   "pricing_c"),
        ("capex_intensity",          "capex"),
    ],
    "FINANCIAL_STRUCTURE": [
        ("debt_burden",             "debt"),
        ("floating_rate_debt_ratio","float_debt"),
        ("debt_maturity_nearterm",  "debt_mat"),
        ("financial_health",        "health"),
        ("earnings_quality",        "quality"),
        ("accruals_ratio",          "accruals"),
        ("buyback_capacity",        "buyback"),
    ],
    "GROWTH_PROFILE": [
        ("revenue_growth_rate",       "rev_growth"),
        ("eps_growth_rate",           "eps_growth"),
        ("eps_acceleration",          "accel"),
        ("forward_growth_expectations","fwd_growth"),
        ("earnings_revision_trend",   "est_trend"),
    ],
    "VALUATION_POSITIONING": [
        ("valuation_multiple",  "multiple"),
        ("factor_value",        "value"),
        ("short_interest_ratio","short_int"),
        ("short_squeeze_risk",  "sq_risk"),
        ("price_momentum",      "momentum"),
    ],
    "GEOGRAPHY_TRADE": [
        ("china_revenue_exposure",        "china"),
        ("emerging_market_exposure",      "em_exp"),
        ("domestic_revenue_concentration","domestic"),
        ("tariff_sensitivity",            "tariff"),
    ],
    "SUPPLY_CHAIN_EXPOSURE": [
        ("upstream_concentration",          "upstream"),
        ("geographic_supply_risk",          "geo_supply"),
        ("inventory_intensity",             "inventory"),
        ("input_specificity",               "input_spec"),
        ("supplier_bargaining_power",       "supplier"),
        ("downstream_customer_concentration","downstream"),
    ],
    "MARKET_BEHAVIOUR": [
        ("institutional_appeal",          "inst_appeal"),
        ("institutional_ownership_change","inst_chg"),
        ("short_squeeze_potential",       "sq_pot"),
        ("earnings_surprise_volatility",  "earn_surp"),
    ],
}
