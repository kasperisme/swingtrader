"""Market-screening bulk LLM analytics.

After a market screening produces its initial ticker list, this worker enriches
...
`market_screening_result_rows.row_data`, not to per-user notes/workspaces.
"""
